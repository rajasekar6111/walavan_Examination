...
describe('FileUploader', function () {
  ...
  describe('props', function () {
    ...
    describe('browseOrDragText', function () {
      it.each([undefined, null])('when %p, should render default text', function (browseOrDragText) {
        renderWithProps({
          browseOrDragText: browseOrDragText
        });

        var defaultElements = _react2.screen.getAllByText(function (content) {
          return content.includes('Browse') || content.includes('or drag files here');
        });

        expect(defaultElements).toHaveLength(2);
      });
      it('when function returns string, should render text wrapped in Paragraph', function () {
        var browseOrDragText = function browseOrDragText() {
          return 'Custom browse text';
        };
        ...
        var container = _react2.screen.getByText(browseOrDragText());
      ...
      it('when function returns non-string, should render returned content', function () {
        var browseOrDragTestId = 'custom-browse-text';

        var browseOrDragText = function browseOrDragText() {
          return /*#__PURE__*/_react["default"].createElement(_typography.Paragraph, {
            "data-testid": browseOrDragTestId
          }, "Custom");
        };
        ...
        expect(_react2.screen.getByTestId(browseOrDragTestId)).toBeInTheDocument();
      });
    });
